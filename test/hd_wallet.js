...
describe("HDWallet", function () {
  ...
  var signer = new HDWallet(phrase, 5);
    ...
    it("signs transaction", function(done) {
      signer.signRawTx("f680850ba43b7400832fefd8949e2068cce22de4e1e80f15cb71ef435a20a3b37c880de0b6b3a7640000890abcdef012345678901c8080",
        ...
        function(e, signedRawTx) {
          ...
          var tx = new Transaction(signedRawTx);
          expect(tx.getSenderPublicKey().toString('hex')).to.equal(util.stripHexPrefix(signer.keypairs[0].publicKey));
          done();
      });
    })
  })
  ...
  describe("changed path", function() {
    var signer = new HDWallet(phrase, 3);
    ...
    describe("getAddress", function() {
      it("returns its 2nd address", function(done) {
        expect(signer.getAddress()).to.equal(address0);
        expect(signer.getAddress(0)).to.equal(address0);
        expect(signer.getAddress(1)).to.equal(address1);
        expect(signer.getAddress(2)).to.equal(address2);
        done();
      })
    })
  });
  ...
  describe("secondary addresses", function() {
    var signer = new HDWallet(phrase, 1);
    signer.addAccounts(2);
    var address1 = "0x653f4156b7e1979af34c0cb1d746a42ed4dc4319";
    var address2 = "0xc0ace8c52c0a2145eb04965904e75e0776ffc4c1";
    ...
    describe("hasAddress", function() {
      it("returns true", function(done) {
        signer.hasAddress(address1, function(e, r){
          expect(r).to.equal(true);
          done();
        })
      })
      it("returns true", function(done) {
        signer.hasAddress(address2, function(e, r){
          expect(r).to.equal(true);
          done();
        })
      })
      it("returns false", function(done) {
        signer.hasAddress("0x1234567890123456789012345678901234567890", function(e, r){
  ...
  describe("getAccounts", function() {
    var signer = new HDWallet(phrase, 2);
    var address0 = "0x7008907ffc8811a5c690b554a81296d38ee35bdd";
    var address1 = "0x653f4156b7e1979af34c0cb1d746a42ed4dc4319";
    it("calls a callback with an array of addresses", function(done) {
      signer.getAccounts(function(e, r){
  ...
  describe("returns an array of addresses", function() {
    ...
    var address1 = "0x653f4156b7e1979af34c0cb1d746a42ed4dc4319";
    it("returns true", function(done) {
      expect(signer.getAddresses()).to.deep.equal(["0x7008907ffc8811a5c690b554a81296d38ee35bdd",
                                                   "0x653f4156b7e1979af34c0cb1d746a42ed4dc4319"]);
      done();
    })
  })
