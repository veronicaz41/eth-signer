...
var MetaIdentityManagerAbi = UportIdentity.MetaIdentityManager.abi;

var IdentityManagerSigner = function(proxyAddress, signer, metaIdentityManagerAddress) {
  this.proxyAddress = proxyAddress;
  this.metaIdentityManagerAddress = metaIdentityManagerAddress;
  this.signer = signer;
}

IdentityManagerSigner.prototype.getAddress = function() {
  return this.proxyAddress;
}

IdentityManagerSigner.prototype.signRawTx = function(rawTx, callback) {
...
module.exports = IdentityManagerSigner;
