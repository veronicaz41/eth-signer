...
TxRelaySigner.isMetaSignatureValid = function(txRelayAddress, decodedMetaTx, nonce, whitelistOwner) {
  if (typeof nonce !== 'string') throw new Error('nonce must be a string')
  var hashInput = '0x1900' + util.stripHexPrefix(txRelayAddress) + util.stripHexPrefix(whitelistOwner)
